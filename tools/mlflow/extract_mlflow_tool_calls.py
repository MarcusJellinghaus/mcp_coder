...
Two modes:
  1. One example per unique tool name (for building test data):
     python tools/mlflow/extract_mlflow_tool_calls.py --unique --output tool_samples/

  2. All tool calls from a specific run (for debugging a session):
     python tools/mlflow/extract_mlflow_tool_calls.py --run <run_id> --output tool_samples/
...
Examples:
    ...
    python tools/mlflow/extract_mlflow_tool_calls.py --run 962a21de --output tool_samples/

    # Scan more runs for unique tools
    python tools/mlflow/extract_mlflow_tool_calls.py --unique --limit 100 --output tool_samples/
"""
