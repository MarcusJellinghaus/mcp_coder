...
- [x] Implementation: move label_config.py and update all imports ([step_2.md](./steps/step_2.md))
- [x] Quality checks: pylint, pytest, mypy — fix all issues
- [x] Commit message prepared
...
- [x] Implementation: switch all github_operations imports to mcp_workspace_github ([step_4.md](./steps/step_4.md))
- [x] Quality checks: pylint, pytest, mypy — fix all issues
- [x] Commit message prepared
...
- [x] Implementation: update architecture configs for github shim ([step_7.md](./steps/step_7.md))
- [x] Quality checks: pylint, pytest, mypy — fix all issues
- [x] Commit message prepared

## Pull Request
- [x] PR review: verify all steps complete and checks pass (review log 2)
- [ ] PR summary prepared
