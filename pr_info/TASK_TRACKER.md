...
- [ ] Add PROMPT_3_TIMEOUT = 900 constant to src/mcp_coder/workflows/create_plan.py (after logger setup, before first function)
- [ ] Add clear multi-line comment explaining the rationale (15 minutes for detailed multi-file plans vs 600s standard timeout)
...
- [ ] Verify constant is defined correctly and module imports successfully
