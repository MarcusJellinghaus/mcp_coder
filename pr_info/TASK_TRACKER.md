...
- [x] Update exception handler to check for None and use fallback
- [x] Revert exception handling to `except Exception` in execute_coordinator_test() (2 locations)
- [x] Revert exception handling to `except Exception` in execute_coordinator_run() (2 locations)
- [x] Update error messages in from_full_name() to include invalid input
- [x] Update test assertions if needed for new error message format
