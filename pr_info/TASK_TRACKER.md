...
- [x] [Step 2 — Tier B (cancel)](./steps/step_2.md) — reconstructed real bridge + `_common.py`; three generic cancel paths inert while blocked; direct resolve unblocks; backstop after resume; `thread.is_alive() is False` after 5s join (#3, D2)
