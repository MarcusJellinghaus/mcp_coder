...
- [x] Update _load_cache_file() return type to CacheData
- [x] Update _save_cache_file() parameter type to CacheData
- [x] Run quality checks: pylint, pytest, mypy for Step 5
