...
- [x] Implementation: extract shared `log_utils.py`, create `copilot_cli_log_paths.py`, update Claude imports + tests
- [x] Quality checks: pylint, pytest, mypy — fix all issues
- [x] Commit message prepared
...
- [x] Implementation: create `copilot_cli_streaming.py` with `ask_copilot_cli_stream()` + event mapping + update `__init__.py` exports + tests
- [x] Quality checks: pylint, pytest, mypy — fix all issues
- [x] Commit message prepared
