...
| 2 | Add branch_name to LLM call sites | ✅ Complete | Committed: db5b551 |
...
- [x] Add `get_branch_name_for_logging()` utility function
- [x] Add tests for utility function
- [x] Update `workflows/implement/core.py` (4 call sites)
- [x] Update `workflows/implement/task_processing.py` (1 call site)
- [x] Update `workflows/create_plan.py` (3 call sites)
- [x] Update `workflows/create_pr/core.py` (1 call site)
- [x] Update `workflow_utils/commit_operations.py` (1 call site)
- [x] Update `cli/commands/prompt.py` (2 call sites)
- [x] Verify all tests pass (1611 tests)
- [x] Commit changes (db5b551)
