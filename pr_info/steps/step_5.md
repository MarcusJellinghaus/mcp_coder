# Step 5: Decouple CI log parser test fixtures from real tool names
...
- No references to `vulture_check.sh` remain in the file
...
Run pytest to verify: mcp__tools-py__run_pytest_check with extra_args ["-n", "auto", "-m", "not git_integration and not claude_cli_integration and not claude_api_integration and not formatter_integration and not github_integration and not langchain_integration"]
