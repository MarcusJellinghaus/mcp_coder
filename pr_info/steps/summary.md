...
| Session | LangChain native `.dict()` serialization for all message types | No format versioning needed |
| Verify | Runtime: package check. Verify cmd: also stdio smoke test | Two levels |

### What is NOT changing

- No changes to existing backend modules (openai, gemini, anthropic)
