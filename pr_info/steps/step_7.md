...
**SKILL.md keeps:**
- Title and role introduction ("You are a technical lead supervising...")
- Setup section (read issue, knowledge base, determine run number, create log)
- Your Role section (Delegate, Triage, Ask, Scope)
- Prerequisites section (plan must exist, partial plans, branch up to date)
