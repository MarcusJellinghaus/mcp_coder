...
Implement Step 2: modify is_session_active() in sessions.py to prioritize
window title check on Windows, and update the existing test that now needs
adjusted mocks. Run all three code quality checks (pylint, mypy, pytest).
