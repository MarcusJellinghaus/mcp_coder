# Step 4: Update `mlflow_conversation` context manager for step-prefixed Phase 1 prompt

> **Context:** See `pr_info/steps/summary.md` for the full design.
> This is the final step — connects the context manager to the step tracking.

## LLM Prompt

```
Implement step 4 of issue #593 (see pr_info/steps/summary.md and pr_info/steps/step_4.md).
