...
| `src/mcp_coder/workflows/vscodeclaude/session_setup.py` | new `build_install_argv`; delete `_coordinator_python` (`:56-66`) |
...
| `tests/workflows/vscodeclaude/test_workspace_startup_script_github.py` | six argv assertions |
...
- `test_workspace_startup_script_github.py`: update the six `build_install_argv`
  ...
  asserts `--skip-overrides` threads through.
