...
- **Comment:** Issue is created with `status-01:created` label, ready for refinement
...
- **Action:** Refine issue description and change label to `status-02:awaiting-planning`
...
- **Interface:** Automatic detection of `status-02:awaiting-planning` label
...
- **Action:** Post implementation plan and change label to `status-04:plan-review`
- **Comment:** Implementation plan is ready for human review and discussion

### 4. Plan Review → Plan Ready

- **Actor:** Developer using LLM
- **Interface:** Label change to `status-05:plan-ready` (with LLM chat support)
...
- **Actor:** Bot (automating LLM)
- **Interface:** Automatic detection of `status-05:plan-ready` label
...
- **Action:** Complete implementation and change label to `status-07:code-review`
- **Comment:** Implementation is complete and ready for human code review

### 7. Code Review → Ready PR

- **Actor:** Developer using LLM
- **Interface:** Label change to `status-08:ready-pr` (with LLM support for decision)
...
- **Actor:** Bot (automating LLM)
- **Interface:** Automatic detection of `status-08:ready-pr` label
...
- **Action:** Complete PR creation and change label to `status-10:pr-created`
...
- **Step 0**: Manual issue creation (with default `status-01:created` label)
...
- **Action:** Change label back to `status-05:plan-ready` to restart implementation
...
- **Action:** Change label back to `status-02:awaiting-planning` for complete restart
