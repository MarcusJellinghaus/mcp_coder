...
from mcp_coder.log_utils import log_function_call, setup_logging
...
class TestLogFunctionCall:
    ...
    @patch("mcp_coder.log_utils.stdlogger")
    ...
    @patch("mcp_coder.log_utils.structlog")
    @patch("mcp_coder.log_utils.stdlogger")
    def test_log_function_call_with_structured_logging(
        ...
        with patch("mcp_coder.log_utils.any", return_value=True):
            # Define a test function
            @log_function_call
            def test_func(a: int, b: int) -> int:
                return a + b
