...
class TestCreatePullRequestDefaultBranch:
    ...
    def test_create_pr_resolves_default_branch_when_none(
        ...
        with patch("mcp_coder.utils.user_config.get_config_values") as mock_config:
            ...
            # Verify get_default_branch_name was called with project_dir
    ...
    def test_create_pr_resolves_master_as_default_branch(
        ...
        mock_get_default.return_value = "master"  # Some repos use master
        ...
        with patch("mcp_coder.utils.user_config.get_config_values") as mock_config:
            ...
            result = manager.create_pull_request(
                title="Test PR",
                head_branch="feature-branch",
                base_branch=None,  # Should resolve to "master"
                body="Body",
            )
            ...
            # Verify PR was created with "master" as base
            call_kwargs = mock_repo.create_pull.call_args[1]
