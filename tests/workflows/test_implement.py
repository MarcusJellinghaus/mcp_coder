...
class TestRunMypyCheck:
    ...
    def test_run_mypy_check_with_no_errors(self, mock_run_mypy):
        ...
        mock_result = MypyCheckResult(has_errors=False, output="No issues found", error_count=0)
    ...
    def test_run_mypy_check_with_errors(self, mock_run_mypy):
        ...
        mock_result = MypyCheckResult(has_errors=True, output=error_output, error_count=1)
        mock_run_mypy.return_value = mock_result
    ...
    def test_run_mypy_check_import_error(self, mock_run_mypy):
        ...
        assert "mcp_coder.mcp_code_checker is required but not available" in str(exc_info.value)
