...
class TestExtractRealErrorMessage:
    ...
    def test_cli_not_found_error(self) -> None:
        ...
        inner_error = CLINotFoundError("Claude Code not found at: C:\\Users\\test\\.local\\bin\\claude.EXE")
...
class TestRetryWithBackoff:
    ...
    def test_success_after_retries(self) -> None:
        ...
        result = _retry_with_backoff(eventually_successful_func, max_retries=3, base_delay=0.01)
...
class TestVerifyClaudeBeforeUse:
    ...
    def test_successful_verification(self, mock_verify: MagicMock, mock_setup: MagicMock) -> None:
    ...
    @patch("mcp_coder.llm_providers.claude.claude_code_api.setup_claude_path")
    @patch("mcp_coder.llm_providers.claude.claude_code_api.verify_claude_installation")
    def test_failed_verification(self, mock_verify: MagicMock, mock_setup: MagicMock) -> None:
    ...
    @patch("mcp_coder.llm_providers.claude.claude_code_api.setup_claude_path")
    @patch("mcp_coder.llm_providers.claude.claude_code_api.verify_claude_installation")
    def test_setup_path_exception(self, mock_verify: MagicMock, mock_setup: MagicMock) -> None:
...
class TestAskClaudeCodeApiErrorHandling:
    ...
    def test_cli_not_found_error_with_path_found(self, mock_find: MagicMock, mock_retry: MagicMock) -> None:
    ...
    @patch("mcp_coder.llm_providers.claude.claude_code_api._retry_with_backoff")
    @patch("mcp_coder.llm_providers.claude.claude_code_api.find_claude_executable")
    def test_cli_not_found_error_without_path_found(self, mock_find: MagicMock, mock_retry: MagicMock) -> None:
    ...
    def test_file_not_found_error_handling(self, mock_retry: MagicMock) -> None:
        ...
        error_msg = exc_info.value.stderr
        assert "File/executable not found" in error_msg  # Fixed: matches actual implementation
