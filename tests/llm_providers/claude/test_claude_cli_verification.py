...
from mcp_coder.llm_providers.claude.claude_cli_verification import verify_claude_cli_installation


class TestVerifyClaudeCliInstallation:
    """Test the verify_claude_cli_installation function."""

    @patch('mcp_coder.llm_providers.claude.claude_cli_verification.verify_claude_installation')
    @patch('mcp_coder.llm_providers.claude.claude_cli_verification._verify_claude_before_use')
    @patch('builtins.print')
    def test_successful_verification(self, mock_print: MagicMock, mock_api_verify: MagicMock, mock_basic_verify: MagicMock) -> None:
    ...
    @patch('mcp_coder.llm_providers.claude.claude_cli_verification._verify_claude_before_use')
    @patch('builtins.print')
    def test_failed_basic_verification(self, mock_print: MagicMock, mock_api_verify: MagicMock, mock_basic_verify: MagicMock) -> None:
    ...
    @patch('mcp_coder.llm_providers.claude.claude_cli_verification._verify_claude_before_use')
    @patch('builtins.print')
    def test_basic_success_api_failure(self, mock_print: MagicMock, mock_api_verify: MagicMock, mock_basic_verify: MagicMock) -> None:
    ...
    @patch('mcp_coder.llm_providers.claude.claude_cli_verification._verify_claude_before_use')
    @patch('builtins.print')
    def test_api_verification_exception(self, mock_print: MagicMock, mock_api_verify: MagicMock, mock_basic_verify: MagicMock) -> None:
    ...
    @patch('mcp_coder.llm_providers.claude.claude_cli_verification._verify_claude_before_use')
    @patch('builtins.print')
    def test_partial_basic_verification_info(self, mock_print: MagicMock, mock_api_verify: MagicMock, mock_basic_verify: MagicMock) -> None:
        ...
        mock_api_verify.return_value = (False, '/usr/local/bin/claude', 'Cannot execute')
