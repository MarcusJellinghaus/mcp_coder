...
class TestAskLLM:
    ...
    def test_ask_llm_routes_to_claude_code(self, mock_ask_claude_code: MagicMock) -> None:
        ...
        mock_ask_claude_code.assert_called_once_with("Test question", method="cli", timeout=30)
    ...
    @patch('mcp_coder.llm_interface.ask_claude_code')
    def test_ask_llm_passes_through_exceptions(self, mock_ask_claude_code: MagicMock) -> None:
    ...
    def test_ask_llm_custom_timeout(self, mock_ask_claude_code: MagicMock) -> None:
        ...
        mock_ask_claude_code.assert_called_once_with("Test question", method="cli", timeout=60)
    ...
    def test_ask_llm_custom_method(self, mock_ask_claude_code: MagicMock) -> None:
        ...
        result = ask_llm("Test question", method="api")  # Even though not implemented yet
        
        mock_ask_claude_code.assert_called_once_with("Test question", method="api", timeout=30)
...
class TestAskClaudeCode:
    ...
    def test_ask_claude_code_routes_to_cli(self, mock_ask_claude_code_cli: MagicMock) -> None:
    ...
    @patch('mcp_coder.claude_code_interface.ask_claude_code_cli')
    def test_ask_claude_code_default_parameters(self, mock_ask_claude_code_cli: MagicMock) -> None:
    ...
    @patch('mcp_coder.claude_code_interface.ask_claude_code_cli')
    def test_ask_claude_code_custom_timeout(self, mock_ask_claude_code_cli: MagicMock) -> None:
...
class TestIntegration:
    ...
    def test_full_routing_chain(self, mock_ask_claude_code_cli: MagicMock) -> None:
        ...
        result = ask_llm("Integration test question", provider="claude", method="cli", timeout=25)
        
        mock_ask_claude_code_cli.assert_called_once_with("Integration test question", timeout=25)
