"""Tests for the pure exit-code contract and the --fail-on-reviews parser flag.

The exit-code helper is pure (no mocking): build small BranchStatusReports and
assert the 2 -> 1 -> 0 precedence. See pr_info/steps/step_2.md.
"""
...
from mcp_coder.cli.commands.check_branch_status import _exit_code
