...
from src.mcp_coder.cli.commands.help import execute_help, get_help_text, get_usage_examples
...
def test_execute_help_returns_success(capsys):
    ...
    assert "MCP Coder - AI-powered software development automation toolkit" in captured.out
