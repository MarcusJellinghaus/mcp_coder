...
# Re-exported: ``ui/startup.py`` imports ``STYLE_CANCELLED`` from this module,
# which no longer uses it itself after the stream-view extraction.
from mcp_coder.icoder.ui.stream_view import STYLE_CANCELLED as STYLE_CANCELLED
from mcp_coder.icoder.ui.stream_view import StreamViewApp
...
class ICoderApp(StreamViewApp):
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        """
        super().__init__(format_tools=format_tools, **kwargs)
        self._core = app_core
